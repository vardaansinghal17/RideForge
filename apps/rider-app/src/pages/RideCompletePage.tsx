...
export default function RideCompletePage() {
  ...
  return (
    <motion.div
      className="relative w-full min-h-screen bg-[var(--rx-bg)] flex flex-col justify-center items-center px-4 py-8 overflow-y-auto no-scrollbar"
    ...
    >
      ...
      <div className="flex flex-col items-center pt-4 pb-6 px-6 z-10">
        ...
        <motion.h1
          className="text-[24px] font-black text-[var(--rx-text)] leading-tight mb-1 text-center"
        ...
        <motion.p
          className="text-[13px] text-[var(--rx-text-3)] text-center font-medium"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <div className="w-full max-w-md z-10">
        <AnimatePresence mode="wait">
          {isSubmitted ? (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-[var(--rx-green-dim)] border border-[var(--rx-green)]/20 flex items-center justify-center mb-4 shadow-[0_0_24px_rgba(16,185,129,0.15)]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-[var(--rx-text-3)] font-medium mt-1">
                  How was your overall ride experience?
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col items-center gap-2.5">
                  ...
                  <span className="text-[12px] font-black text-[#E54E18] tracking-widest uppercase">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/80 border border-black/5 rounded-xl px-4 py-3 text-[13px] text-[var(--rx-text)] placeholder-[var(--rx-text-3)] outline-none focus:border-black/20 focus:bg-white focus:shadow-sm resize-none transition-all duration-200"
                  />
                </div>
                ...
                {ratingMutation.isError && (ratingMutation.error as any)?.response?.status !== 409 && (
                  <div className="bg-red-50 border border-red-200 rounded-xl p-3 text-left">
                    <p className="text-xs text-red-600 font-semibold leading-relaxed">
                      {(ratingMutation.error as any)?.response?.data?.message ||
                        (ratingMutation.error as any)?.message ||
                ...
                <div className="flex flex-col gap-3 mt-2">
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-[#FF5A1F] to-[#EA580C] text-white font-extrabold text-sm rounded-xl shadow-[0_4px_16px_rgba(255,90,31,0.28)] hover:shadow-[0_6px_20px_rgba(255,90,31,0.36)] transition-all cursor-pointer disabled:opacity-50"
                  >
                  ...
                  <div className="text-center">
                    <button
                      type="button"
                      onClick={handleSkip}
                      className="text-[13px] text-[var(--rx-text-3)] hover:text-[var(--rx-text-2)] font-semibold underline underline-offset-2 bg-transparent border-none cursor-pointer transition-colors"
                    >
                      Skip rating & go home
                    </button>
                  </div>
