...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-slate-50">
      ...
      <GlassCard className="w-full max-w-[440px] fade-up p-8 text-center bg-white border border-slate-200/80 rounded-2xl shadow-xl shadow-slate-100 relative z-10">
        <div className="mb-6">
          ...
          <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-1.5">Create Driver Account</p>
        </div>
        ...
        <div className="mt-6 text-xs text-slate-500 font-bold uppercase tracking-wider">
          ...
          <Link to="/login" className="text-[#FF5A1F] hover:text-orange-600 font-black transition-colors ml-1">
            Sign In
          </Link>
        </div>
      </GlassCard>
